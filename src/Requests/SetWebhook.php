...
class SetWebhook extends Request
{
     ...
     * @return SetWebhook
     */
    public function setUrl(string $url): SetWebhook
    {
        $this->url = $url;
        return $this;
    }
     ...
     * @return SetWebhook
     */
    public function setCertificate(?InputFile $certificate): SetWebhook
    {
     ...
     * @return SetWebhook
     */
    public function setIpAddress(?string $ip_address): SetWebhook
    {
     ...
     * @return SetWebhook
     */
    public function setMaxConnections(?int $max_connections): SetWebhook
    {
     ...
     * @return SetWebhook
     */
    public function setAllowedUpdates(?array $allowed_updates): SetWebhook
    {
     ...
     * @return SetWebhook
     */
    public function setDropPendingUpdates(?bool $drop_pending_updates): SetWebhook
    {
     ...
     * @return SetWebhook
     */
    public function setSecretToken(?string $secret_token): SetWebhook
    {
